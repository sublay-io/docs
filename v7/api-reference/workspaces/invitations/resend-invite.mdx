...
<AccordionGroup>
  ...
  <Accordion title="Missing Invite Accept URL — 409">
    ...
    ```
    A **project misconfiguration**, not a bad request. The row is not touched — `expiresAt` is unchanged and no email is sent. Set [`workspaceInviteAcceptUrl`](/sdk/workspaces/overview#project-settings) and retry.
  </Accordion>
