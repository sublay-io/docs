...
- Subject to the **enforced-default lock**: if the project sets [`workspaceInheritEnforced`](/sdk/workspaces/overview#project-settings), the flip is rejected with `403 workspace/inherit-enforced`.
