---
title: "List Messages"
api: "GET /v7/:projectId/chat/conversations/:conversationId/messages"
...
<ParamField query="include" type="string">
  Comma-separated list of extra fields to include: `files` (attachments) and `grants` (the [reputation-grant summary](/data-models/reputation-grant#grantsummary)). Combine them as `include=files,grants`.
</ParamField>
