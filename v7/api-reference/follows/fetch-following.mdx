...
api: "GET /v7/:projectId/follows/following"
description: "Get a paginated list of users the authenticated user follows"
---

Returns a paginated list of users that the authenticated user is following. Unlike the [user-scoped endpoint](/api-reference/users/follows/get-following), this route always returns data for the current authenticated user.
...
- [Get Following (by user ID)](/api-reference/users/follows/get-following)
