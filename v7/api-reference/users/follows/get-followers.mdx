...
Returns a paginated list of users who follow the specified user. Authentication is optional. The endpoint works without a token, but when the caller is signed in, users they have blocked are excluded from the results.
