...
<ParamField path="relativeRank" type="number">
  New rank as an **offset from you**: `1` = one rung below me. Must be `>= 1`. Anchored on your own rank if you hold a member row on this workspace, apex otherwise. Resolved to an absolute number at write time and frozen — a **snapshot**, not a link to your rank. No default: omitting both rank fields leaves rank unchanged.
</ParamField>
