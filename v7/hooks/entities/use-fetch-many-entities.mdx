...
<ResponseField name="data" type="Entity[]">
  Array of entities for the current page. When `spaceReputationId` is set, each embedded author carries an added `spaceReputation` number. See [Reputation](/data-models/reputation).
</ResponseField>
