...
<ResponseField name="signedOut" type="boolean">
  ...
  out** — or removed the active account, deleted it, abandoned an `addAccount()`
  flow, or had a stored credential refused at launch — as opposed to "nothing
  has ever been selected". Both look like `activeAccount === null`; this is what
