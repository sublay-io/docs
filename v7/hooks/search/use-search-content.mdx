...
<ResponseField name="results" type="ContentSearchResult[]">
  ...
  <Expandable title="ContentSearchResult properties">
    ...
    <ResponseField name="record" type="Entity | Comment | ChatMessage">
      The full matched record. When `spaceReputation` is requested, its embedded author carries an added `spaceReputation` number. See [Reputation](/data-models/reputation).
    </ResponseField>
  </Expandable>
</ResponseField>
