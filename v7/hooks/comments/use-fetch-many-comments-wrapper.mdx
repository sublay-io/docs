...
<ParamField body="defaultSortBy" type='"createdAt" | "top" | "controversial"' optional>
  Initial sort order. Default: `"createdAt"`. `"new"`/`"old"` are deprecated aliases for `"createdAt"` (removed in v8).
</ParamField>
