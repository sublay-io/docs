...
<ResponseField name="data" type="SpaceMemberWithUser[]">
  Array of [SpaceMemberWithUser](/data-models/space-member) objects including embedded user details. When `spaceReputation` is requested, each embedded user carries an added `spaceReputation` number. See [Reputation](/data-models/reputation).
</ResponseField>
