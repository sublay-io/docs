...
Because OAuth identity lives in core, [OAuth sign-in](/sdk/authentication/oauth) — including on Expo — works on every project without installing anything extra.
