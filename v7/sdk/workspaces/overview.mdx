...
| **Visibility** | The caller must be able to see the workspace / its roster at all. This is the gate on the reads — the single workspace, the roster, and one member's standing. |
