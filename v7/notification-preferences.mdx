...
| `entity-upvote` | `initiatorName`, `initiatorUsername`, `entityTitle` |
| `comment-upvote` | `initiatorName`, `initiatorUsername`, `entityTitle`, `commentContent` |
