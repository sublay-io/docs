---
title: "Get Received Pending Requests"
api: "GET /api/v6/:projectId/connections/pending/received"
description: "Get connection requests received by the current user that are still pending"
auth: "bearer"
---
